<%-- 
    Document   : bsaStockTransferPending
    Created on : 22 Jan, 2019, 5:40:56 PM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase" id="itemHead">BSA PENDING</span>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col col-xs-2 pull-right">
                            <button class="btn btn-primary sub btn-block" id="buttonConfirm" aria-hidden="true">Confirm
                                Stock</button>
                        </div>
                        <div class="col col-xs-2 pull-right">
                            <button class="btn dark  btn-block btn-outline" data-dismiss="modal" aria-hidden="true">Close</button>
                        </div>
                    </div>
    ...
    <script src="assets/scripts/bsaStockTransferPending.js" type="text/javascript"></script>
