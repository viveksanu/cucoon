<%-- 
    Document   : adminViewStock
    Created on : 30 Nov, 2018, 5:50:35 PM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class='nav-item start'>
                        <a class='nav-link' data-toggle="modal" href="#modalNewItem"> <i class='icon-settings'></i>
                            <span class='title'>New Item</span></a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <div class="container">
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase" id="itemHead">VIEW STOCK</span>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id='selectClinic' name='branchId' class="form-control select select2"></select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-2 col-xs-4">
                                                    <div class="form-group">
                                                        <br>
                                                        <button type="submit" class="btn btn-info btn-block btn-icon"><i
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" id="formNewItem">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="itemName" autofocus autocomplete="off" class="form-control"
                                                    maxlength="200" required id="itemName">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <label class="radio-inline">
                                                    <input type="radio" class="iType" name="iType" id="radioUnit" value="1"
                                                        checked>Unit </label>
                                                <label class="radio-inline">
                                                    <input type="radio" name="iType" class="iType" id="radioLoose"
                                                        value="2">Loose</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" required step="0.01" class="form-control" name="costPrice"
                                                    maxlength="9">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control" step="0.01" required name="sellingPrice"
                                                    maxlength="9">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control" disabled id="itemmsu" value="1"
                                                    required name="msu" maxlength="9" min="1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="expiryDate" autocomplete="off"
                                                    id="itemExpiryDate">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea maxlength="50" name="comment" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div>
                    ...
                    <div id="modalEditItem" class="modal fade" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" id="formEditItem">

                                        <div class="form-group">
                                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                                            <div class="col-md-9">
                                                <input type="text" name="itemName" autofocus autocomplete="off" class="form-control"
                                                    maxlength="200" required id="eitemName">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-3 col-sm-3 col-sm-push-3">
    ...
    <script src="assets/scripts/adminViewStock.js" type="text/javascript"></script>
