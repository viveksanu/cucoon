<%-- 
    Document   : branchDoctor
    Created on : 4 Oct, 2018, 1:52:58 PM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class='nav-item start'>
                        <a class='nav-link' data-toggle="modal" href="#modalAddDoctor">
                            <i class='icon-settings'></i>
                            <span class='title'>Add Doctor</span></a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase" id="itemHead">BRANCH DOCTOR</span>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="stDoctor" role="form" method="get" class="form-horizontal" id="formNew">
                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" id="name" maxlength="200" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Gender <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <label class="radio-inline">
                                    <input type="radio" name="sex" id="radioFemale" value="Female" checked> Female
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="sex" id="radioMale" value="Male"> Male </label>
                                <label class="radio-inline">
                                    <input type="radio" name="sex" id="radioOthers" value="Others"> Others </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                    ...
                                    <input type="text" name="dob" id="dob" size="16" class="form-control" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="contact" maxlength="45">
                            </div>
                        </div>
                        <div class="form-group">
                            <div>
    ...
    <div id="modalAddDoctor" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="stDoctor" role="form" method="get" class="form-horizontal" id="formAddDoctor">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select id="selectDoctor" name="did" class="form-control select2">
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div>
                                <div class="col-md-3 col-md-push-3 col-sm-4 col-sm-push-4">
                                    <button class="btn green btn-block" id="buttonAddDoctor" type="submit">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form role="form" method="post" class="form-horizontal" id="formEdit">
                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" id="ename" maxlength="200" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Gender <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <label class="radio-inline">
                                    <input type="radio" name="sex" id="eradioFemale" value="Female" checked> Female
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="sex" id="eradioMale" value="Male"> Male </label>
                                <label class="radio-inline">
                                    <input type="radio" name="sex" id="eradioOthers" value="Others"> Others </label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Date of Birth</label>
                            <div class="col-md-9">
                                <input type="text" name="dob" id="edob" size="16" class="form-control" autocomplete="off">
                                </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Phone Number</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="ephoneNumber" name="contact" maxlength="45">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-3 col-sm-3 col-sm-push-3">
...
<![endif]-->
    ...
    <script src="assets/scripts/branchDoctor.js" type="text/javascript"></script>
