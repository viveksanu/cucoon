<%-- 
    Document   : branchInfo
    Created on : 23 Oct, 2018, 8:54:14 PM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
                    ...
                    <div class="row">
                        <div class="col-md-6 ">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <a class="btn btn-default btn-sm" id="editInfo">
                        ...
                        <div class="col-md-6 ">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="cfcM">Form Prefix</span>
                                    </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="btn btn-default btn-sm " id="editCfc">
                                            <i class="fa fa-pencil"></i>Edit</a>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table" id="tableCfc">
                                        <tr>
                                            <td>CFC</td>
                                            <td id="cfc"></td>
                                            <td>Counter</td>
                                        ...
                                        <tr>
                                            <td>Invoice</td>
                                            <td id="invoicePrefix"></td>
                                            <td>Counter</td>
                                            <td id="invoiceCounter"></td>
                                        </tr>
                                        <td>Receipt</td>
                                        <td id="receiptPrefix"></td>
                                        <td>Counter</td>
                                        <td id="receiptCounter"></td>
                                        </tr>
    ...
    <!-- END CONTENT -->
    <div id="modalEditBranch" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="formEditBranch">

                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" maxlength="100" required id="ename">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label class="radio-inline">
                                    <input type="radio" name="ctype" id="eradioS" value="1"> Subsidiary </label>
                                <label class="radio-inline">
                                    <input type="radio" name="ctype" id="eradioF" value="0"> Franchise </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" id="ephone" required name="contact" maxlength="45">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea maxlength="200" class="form-control" id="eaddress" name="address"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div id="modalEditCfc" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Edit Counters</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" id="formEditCfc">

                        <div class="form-group">
                            <label class="control-label col-md-3">CFC Prefix <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="cfc" class="form-control" maxlength="45" required id="ecfc">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Counter <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" class="form-control" id="ecounter" required name="counter"
                                    maxlength="45">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="invoicePrefix" class="form-control" maxlength="45" required id="einvoicePrefix">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Counter <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" class="form-control" id="einvoiceCounter" required name="invoiceCounter"
                                    maxlength="45">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="receiptPrefix" class="form-control" maxlength="45" required id="ereceiptPrefix">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Counter <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" class="form-control" id="ereceiptCounter" required name="receiptCounter"
                                    maxlength="45">
                            </div>
                        </div>
...
<![endif]-->
    ...
    <script src="assets/scripts/branchInfo.js" type="text/javascript"></script>
