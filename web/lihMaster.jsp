<%-- 
    Document   : lihMaster
    Created on : 19 Mar, 2019, 1:25:25 PM
    Author     : vivek
--%>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class='nav-item start'>
                        <a class='nav-link' data-toggle="modal" href="#modalNew">
                            ...
                            <span class='title'>New Lab Investigation Report</span></a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase" id="itemHead">SOURCES</span>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  role="form" method="get" class="form-horizontal" id="formNew">
...
<![endif]-->
    ...
    <script src="assets/scripts/lihMaster.js" type="text/javascript"></script>
