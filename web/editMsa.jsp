<%-- 
    Document   : editMsa
    Created on : 14 Nov, 2018, 8:54:38 AM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class="nav-item start active open">
                        ...
                        <ul class="sub-menu">
                            <li class="nav-item start active open">
                                <a href="#modalNewCustomer" class="nav-link " data-toggle="modalNewItem">
                            ...
                            <li class="nav-item start">
                                <a href="#modalExistingPatient" class="nav-link " data-toggle="modalNewBatch">
                                    <i class='icon-settings'></i>
                                                ...
                                                <div class="table-scrollable">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select required="true" id="selectaddItemName" onchange="changeItemName()"
                                                            ...
                                                            <td> <button class="btn btn-block btn-success vieww" type="submit"
                            ...
                            <div class="portlet light">
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 pull-right">
                                            <input type="button" class="btn dark btn-block btn-outline" id='clear'
                                                value="CLEAR">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="formNewItem">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" name="costPrice" maxlength="9">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script src="assets/scripts/editMsa.js" type="text/javascript"></script>
