<%-- 
    Document   : procedureMaster
    Created on : 6 Nov, 2018, 3:54:40 PM
    Author     : vivek
--%>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class='nav-item start'>
                        <a class='nav-link' data-toggle="modal" href="#modalNew">
                            ...
                            <span class='title'>New Procedure</span></a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <span class="caption-subject bold uppercase">PROCEDURE MASTER</span>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Procedure/Package Details</h4>
                </div>
                <div class="modal-body">
                    <form action="stProcedure" role="form" method="get" class="form-horizontal" id="formNew">
                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" id="name" autofocus maxlength="100"
                                    required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3">Cost <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" step="0.01" class="form-control" required name="cost" maxlength="10">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div id="modalEdit" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" onsubmit="return false;" class="form-horizontal" id="formEdit">
                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" id="ename" maxlength="100" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Cost <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" step="0.01" class="form-control" id="ecost" name="cost" maxlength="10">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Description</label>
                            <div class="col-md-9">
                                <textarea class="form-control" name="description" id="edescription" maxlength="200"></textarea>
...
<![endif]-->
    ...
    <script src="assets/scripts/procedureMaster.js" type="text/javascript"></script>
