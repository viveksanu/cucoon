                ...
                <tr>
                    ...
                    <td>
                        <table style="margin-top: 35px;">
                            <tr>
                                <td  n-b bold style="width: 75px; font-size: 16px;">Name :</td>
                                <td  n-b style="width: 220px; font-size: 16px;" id='name'></td>
                                <td  n-b bold style="width: 78px; font-size: 16px;"> Bill No. :</td>
                                <td  n-b style="width: 175px; font-size: 16px;" id="billNo"> </td>
                            </tr>
                            <tr>
                                <td bold n-b style="font-size: 16px;">Age :</td>
                                <td n-b id="age" style="font-size: 16px;"></td>
                            ...
                            <tr>
                                ...
                                <td n-b style="font-size: 16px;" id="cfc"></td>
                                <td bold n-b style="font-size: 16px;">Doctor :</td>
                                <td n-b style="font-size: 16px;" id="doctor"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <table id="tableReceipts">
                        ...
                        <table>
                                <tr>
                                        <td n-b-r n-b-t n-b-b bold text-right style="width: 450px;"></td>
                                        <td n-b-r n-b-t n-b-l bold text-left >Total Amount</td>
                                        <td n-b-l n-b-t bold text-right style="width: 250px;" id="rtotalAmount"> </td>
                                </tr>
                                <!-- <tr>
                                        <td n-b-r n-b-t n-b-b text-right bold style="width: 450px;" ></td>
...
<!-- invoice-bill-2 -->
    ...
    <script src="assets/scripts/finalBill.js" type="text/javascript"></script>
