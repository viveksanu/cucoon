<%-- 
    Document   : patient
    Created on : 22 Oct, 2018, 5:27:10 PM
    Author     : vivek
--%>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class="nav-item start active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="icon-home"></i>
                            <span class="title">Add Info</span>
                            <span class="selected"></span>
                            <span class="arrow open"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start active open">
                                <a class="nav-link cfc female" data-toggle="modal">
                                    <i class='icon-settings'></i>
                                    <span class="title">Female Patient</span>
                                    <span class="selected"></span>
                                </a>
                            </li>
                            <li class="nav-item start">
                                <a class="nav-link cfc male" data-toggle="modal">
                                    <i class='icon-settings'></i>
                                    <span class="title">Male Patient</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <div class="row">
                          <div class="col-md-4 ">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <a href="javascript:;" class="btn btn-default btn-sm " id="editBasic"> 
                                ...
                                <div class="portlet-body">
                                    <table class="table" id="tableF">
                                        ...
                                        <tr>
                                            ...
                                            <td id="bprimaryContact"></td>
                                        </tr>
                                        <tr>
                                            <td>Secondary Contact</td>
                                            <td id="bsecondaryContact"></td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
                                            <td id="bemail"></td>
                        ...
                        <div class="col-md-4 ">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="cfcF">Female</span>
                                    </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="btn btn-default btn-sm ecfc female">
                                            <i class="fa fa-pencil"></i> Edit </a>
                                    </div>
                                </div>
                                <div class="portlet-body">
                        ...
                        <div class="col-md-4 ">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="cfcM">Male</span></div>
                                    <div class="actions">
                                        <a href="javascript:;" class="btn btn-default btn-sm ecfc male">
                                            <i class="fa fa-pencil"></i> Edit </a>
                                    </div>
                                </div>
                                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="">Treatment History</span></div>
                                    <div class="actions">
                                        <a data-toggle="modal" href="#modalNewTreatment" class="btn btn-default btn-sm "
                                            id="btnNewTreatment">
                                            <i class="fa fa-pencil"></i>New Treatment</a>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-bordered table-hover table-checkable order-column" id="tableTreatment">
                                        <thead>
                                            <th>Name</th>
                                            <th>Patient</th>
                                            <th>Doctor</th>
 ...
 <div class="row">
                        <div class="col-md-12 ">
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="">Branch Access</span></div>
                                    <div class="actions">
                                        <a data-toggle="modal" href="#modalNewBranchAccess" class="btn btn-default btn-sm "
                                            id="btnNewTreatment">
                                            <i class="fa fa-pencil"></i>New Access</a>
                                    </div>
                                    <div class="tools">
                                        <a href="javascript:;" class="collapse"> </a>
                                ...
                                <div class="portlet-body">
                                    <table class="table table-bordered table-hover table-checkable order-column" id="tableBranchAccess">
                                        <thead>
                                            <th>Name</th>
                                            <th></th>
                                        </thead>
    ...
    <!-- END CONTENT -->
    <div id="modalAddInfo" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="stPatient" role="form" method="get" class="form-horizontal" id="formAddInfo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" maxlength="100" id="gender"
                                    disabled>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3">DOB <sup class="require">*</sup></label>
                            <div class="col-md-9">
    ...
    <div id="modalNewBranchAccess" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="get" class="form-horizontal" id="formNewBranchAccess">

                        <div class="form-group">
                            <label class="control-label col-md-3">Select Branch<sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <select type="text" name="branch" class="form-control select2" id="selectBranch"
                                    required></select>
                            </div>
                        </div>
    ...
    <div id="modalNewTreatment" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="get" class="form-horizontal" id="formNewTreatment">

                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" maxlength="100" id="treatmentName"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select type="text" name="doctor" class="form-control select2" id="selectDoctor"
                                    required></select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" required name="startDate" class="form-control" maxlength="10" id="startDate">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3">Payment Due <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" required name="dueDate" class="form-control" maxlength="10" id="dueDate">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Comment</label>
                            <div class="col-md-9">
                                <textarea name="comment" id="comment" class="form-control" maxlength="100"></textarea>
                            </div>
                        </div>
    ...
    <div id="modalEditTreatment" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="get" class="form-horizontal" id="formEditTreatment">

                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" maxlength="100" id="etreatmentName"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Select Doctor <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <select name="doctor" class="form-control select2" id="eselectDoctor" required>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Date <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" required name="startDate" class="form-control" maxlength="10" id="estartDate"
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Payment Due <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" required name="dueDate" class="form-control" maxlength="10" id="edueDate"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Comment</label>
                            <div class="col-md-9">
                                <textarea name="comment" id="ecomment" class="form-control" maxlength="100"></textarea>
                            </div>
                        </div>
    ...
    <div id="bmodalEditPatient" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="bformEditPatient">

                        <div class="form-group">
                            <label class="control-label col-md-4">Name <sup class="require">*</sup></label>
                            <div class="col-md-8">
                                <input type="text" autocomplete="off" name="name" autofocus class="form-control" id="bename"
                                    maxlength="100" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4">Source <sup class="require">*</sup></label>
                            <div class="col-md-8">
                                <select id="beselectSource" name="source" class="form-control select2 " required>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4">Contact Number <sup class="require">*</sup></label>
                            <div class="col-md-8">
                                <input type="number" id="becontact1" required class="form-control" name="contact1"
                                    maxlength="45">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-4">Alternate Number</label>
                            <div class="col-md-8">
                                <input type="number" id="becontact2" class="form-control" name="contact2" maxlength="45">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="email" multiple="true" autocomplete="off" id="beemail" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea maxlength="200" id="beaddress" autocomplete="off" name="address"></textarea>
...
<![endif]-->
    ...
    <script src="assets/scripts/patient.js" type="text/javascript"></script>
