<%-- 
    Document   : roomMaster
    Created on : 25 Oct, 2018, 3:37:53 PM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
            ...
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class='nav-item start'>
                        <a class='nav-link' data-toggle="modal" href="#modalNewRoom">
                            <i class='icon-settings'></i>
                            <span class='title'>New Room</span></a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <span class="caption-subject bold uppercase">ROOM MASTER</span>
                                    </div>
                                </div>
    ...
    <div id="modalNewRoom" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="stBasics" role="form" method="get" class="form-horizontal" id="formNewRoom">
                        <div class="form-group">
                            <label class="control-label col-md-3">Select Room Type <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <select id="selectRoomType" name="roomType" class="form-control ">
                                    <option value="0">Operation Theatre</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" maxlength="45" required id="name">
                            </div>
                        </div>
    ...
    <div id="modalEditRoom" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="stBasics" role="form" method="get" class="form-horizontal" id="formEditRoom">
                        <div class="form-group">
                            <label class="control-label col-md-3">Select Room Type <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <select id="eselectRoomType" name="roomType" class="form-control ">
                                    <option value="0">Operation Theatre</option>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" maxlength="45" required id="ename">
                            </div>
                        </div>
...
<![endif]-->
    ...
    <script src="assets/scripts/roomMaster.js" type="text/javascript"></script>
