<%-- 
    Document   : customerCareSource
    Created on : 18 Feb, 2019, 3:53:02 PM
    Author     : vivek
--%>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class='nav-item start'>
                        <a class='nav-link' data-toggle="modal" href="#modalNew">
                            ...
                            <span class='title'>New Source</span></a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="stCustomerCare" role="form" method="post" class="form-horizontal" id="formNew">
                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" name="name" autofocus class="form-control" id="name" maxlength="200"
                                    required>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form role="form" method="post" class="form-horizontal" id="formEdit">
                        <div class="form-group">
                            <label class="control-label col-md-3">Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" autofocus name="name" class="form-control" id="ename" maxlength="200"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
...
<![endif]-->
    ...
    <script src="assets/scripts/customerCareSource.js" type="text/javascript"></script>
