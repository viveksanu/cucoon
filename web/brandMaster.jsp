<%-- 
    Document   : stockSupplierMaster
    Created on : 20 Feb, 2019, 7:45:05 PM
    Author     : vivek
--%>
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class='nav-item start'>
                        <a class='nav-link' data-toggle="modal" href="#modalNew">
                            ...
                            <span class='title'>New Brand</span></a>
                    </li>
                </ul>
                <!-- END SIDEBAR MENU -->
            </div>
...
<![endif]-->
    ...
    <script src="assets/scripts/brandMaster.js" type="text/javascript"></script>
