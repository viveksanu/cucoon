<%-- 
    ...
    Created on : 21 Jan, 2019, 9:09:24 PM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <span class="caption-subject bold uppercase">Inter Stock Transfer</span>
                                    </div>
                                </div>
    ...
    <script src="assets/scripts/bsaStockTransferAll.js" type="text/javascript"></script>
