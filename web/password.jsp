<%-- 
    Document   : password
    Created on : 14 Mar, 2019, 4:26:54 PM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed">
                                    ...
                                    <form id="passForm" method="post">
                                        ...
                                        <div class='form-row'>
                                            <div class='col-xs-12 form-group required'>
                                                ...
                                                <input class='form-control' autofocus autocomplete='off' maxlength="45"
                                                    size='20' type='password' id="cpassword" name="cpassword" required>
                                        ...
                                        <div class='form-row'>
                                            <div class='col-xs-12 form-group card required'>
                                                ...
                                                <input autocomplete='off' class='form-control card-number' maxlength="45"
                                                    size='20' name="newPassword" id="newPassword" type='password'>
                                            </div>
                                        </div>
                                        <div class='form-row'>
                                            <div class='col-xs-12 form-group card required'>
                                                <label class='control-label'>Repeat password</label>
                                                <input autocomplete='off' class='form-control' size='20' id="confirmPassword"
                                        ...
                                        <div class='form-row'>
                                            <div class='col-md-12 form-group'>
                                                <button class='form-control btn btn-primary submit-button' type='submit'
                                                    id="save">Change Password</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <script src="assets/scripts/password.js" type="text/javascript"></script>
