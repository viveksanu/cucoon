<%-- 
    ...
    Created on : 5 Jan, 2019, 10:47:54 AM
    Author     : vivek
--%>
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-3">
                                                    <div class="form-group">
                                                        <label>CFC</label>
                                                        <input id="searchCfc" name="cfc" class="form-control" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-md-3">
                                                    <div class="form-group">
                                                        <label>Primary Number</label>
                                                        <input id="searchNumber" name="number" class="form-control"
                                                            type="text">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-md-3">
    ...
    <div id="modalEditPatient" class="modal fade" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="formEditPatient">

                        <div class="form-group">
                            <label class="control-label col-md-4">Name(*)</label>
                            <div class="col-md-8">
                                <input type="text" autocomplete="off" name="name" autofocus class="form-control" id="ename"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number" id="econtact1" required class="form-control" name="contact1"
                                    maxlength="45">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number" id="econtact2" class="form-control" name="contact2" maxlength="45">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="email" multiple="true" autocomplete="off" id="eemail" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea maxlength="200" id="eaddress" autocomplete="off" name="address"></textarea>
    ...
    <script src="assets/scripts/viewPatient.js" type="text/javascript"></script>
