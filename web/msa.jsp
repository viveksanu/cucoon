...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class="nav-item start active open">
                        <a href="javascript:;" class="nav-link nav-toggle">
                            <i class="icon-home"></i>
                            <span class="title">New Item/Batch</span>
                            <span class="selected"></span>
                            <span class="arrow open"></span>
                        </a>
                        <ul class="sub-menu">
                            <li class="nav-item start active open">
                                <a class="nav-link " data-toggle="modal" href="#modalNewItem">
                            ...
                            <li class="nav-item start">
                                <a class="nav-link " data-toggle="modal" href="#modalNewBatch">
                                    <i class='icon-settings'></i>
                                    <span class="title">New Batch</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <span class="caption-subject bold uppercase">STOCK ALLOCATION</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                <label>Reference Number <sup class="require">*</sup></label>
                                        ...
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                <label>Comment</label>
                                                <textarea name="comment" maxlength="200" class="form-control" id="comment"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="col-xs-12">
                                                <table class="table table-striped">
                                                    <thead>
                                                        ...
                                                        <th class="col-xs-1">MSU</th>
                                                        <th class="col-xs-1">Cost Price</th>
                                                        <th class="col-xs-1">Selling Price</th>

                                                    </thead>
                                                    <tr>
                                                        <td><select required="true" id="selectBrand" class="form-control select2"></select>
                                                        </td>
                                                        <td><select required="true" id="selectaddItemName" onchange="changeItemName()"
                                                                class="selectItemName form-control select2">
                                                                <!--                                            <option value="">Item Name</option>   -->
                                                            </select>
                                                        </td>

                                                        <td><select required="true" id="selectaddBatchName" class="form-control select2 "
                                                        ...
                                                        <td><input type="number" disabled min="0" id="addCP" class=" form-control">
                                                        </td>

                                                        <td><input type="number" disabled min="0" id="addSP" class=" form-control">
                                                        </td>
                                                        <td> <button class="btn btn-success btn-block" type="submit" id="addStock">Add</button>
                                                        </td>
                                                    </tr>
    ...
    <!-- END CONTENT -->
    <div id="modalNewItem" class="modal fade" role="dialog" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="formNewItem">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="itemName" class="form-control" maxlength="200" required id="itemName">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3">Sold As</label>
                            <div class="col-md-9">
                                <label class="radio-inline">
                                    <input type="radio" class="iType" name="iType" id="radioUnit" value="1" checked>Unit
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="iType" class="iType" id="radioLoose" value="2">Loose</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Batch Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" required name="batchName" maxlength="100">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" required name="costPrice" maxlength="9">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Selling Price <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" class="form-control" required name="sellingPrice" maxlength="9">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Max Selling Unit <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" class="form-control" disabled id="itemmsu" value="1" required name="msu"
                                    maxlength="9" min="1">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="expiryDate" autocomplete="off" id="itemExpiryDate">
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="formNewBatch">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select id="selectItem" name="item" class="form-control no-placeholder select select2"
                                    required>
                                </select>
                                <select id="selectItemType" hidden="true">
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Batch Name <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" required name="batchName" maxlength="100" id="batchbatchName">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Cost Price<sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input required type="number" step="0.01" class="form-control" name="costPrice" maxlength="9">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Selling Price <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" step="0.01" class="form-control" required name="sellingPrice" maxlength="9">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Max Selling Unit <sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <input type="number" class="form-control" required name="msu" maxlength="9" min="1" id="batchmsu">
                            </div>
                        </div>
    ...
    <script src="assets/scripts/msa.js" type="text/javascript"></script>
