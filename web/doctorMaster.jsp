                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase" id="itemHead">DOCTOR</span>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <form action="stDoctor" role="form" method="get" class="form-horizontal" id="formNew">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="username" class="form-control" id="name" maxlength="100"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Assign Branch<sup class="require">*</sup></label>
                            <div class="col-md-9">
                                <select id='selectClinic' name='branchId' required class="form-control select select2"></select>
                            </div>
                        </div>
...
<![endif]-->
    ...
    <script src="assets/scripts/doctorMaster.js" type="text/javascript"></script>
