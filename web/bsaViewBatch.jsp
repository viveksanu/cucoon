<%-- 
    Document   : bsaViewBatch
    Created on : 3 Dec, 2018, 7:10:35 PM
    Author     : vivek
--%>
...
<head>
    ...
    <!--    <link href="assets/css/global/jquery.notific8.min.css" rel="stylesheet" type="text/css" />-->
...
<body class="page-sidebar-closed-hide-logo page-container-bg-solid page-md page-header-fixed page-sidebar-fixed page-footer-fixed"
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase" id="itemHead">BSA VIEW BATCH</span>
                                    </div>
                                </div>
    ...
    <script src="assets/js/global/jquery.notific8.min.js" type="text/javascript"></script>
    ...
    <script src="assets/scripts/bsaViewBatch.js" type="text/javascript"></script>
